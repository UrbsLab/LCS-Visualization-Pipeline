...
class ClusterTree:
    def __init__(self,linkage_matrix,instance_labels,instances):
        ...
        for label in instance_labels:
            self.clusters.append(Cluster([self.label_to_index_map[label]],None,None,None))
        ...
        for row in linkage_matrix:
            ...
            new_cluster = Cluster(combined_instance_indices,cluster_index_1,cluster_index_2,distance_between_clusters)
    ...
    def getSignificantClusters(self,metric,method,p_value=0.05,sample_count=30):
        if self.significant_clusters == None:
            ...
            return self.indicesToLabels(self.significant_clusters)
        else:
            return self.indicesToLabels(self.significant_clusters)
...
class Cluster:
    def __init__(self,instance_index_array,child_index_1,child_index_2,distance_between_chidren):
        '''
